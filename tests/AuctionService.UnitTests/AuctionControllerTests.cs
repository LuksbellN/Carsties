...
public class AuctionControllerTests
{
    ...
    public AuctionControllerTests()
    {
        ...
        _controller = new AuctionController(_mapper, _publishEndpoint.Object, _auctionRepo.Object)
        {
    ...
    public async Task UpdateAuction_WithValidUpdateAuctionDto_ReturnsOk()
    {
        ...
        var auctionUpdated = _fixture.Create<UpdateAuctionDto>();
        _auctionRepo.Setup(repo => repo.GetAuctionEntityById(It.IsAny<Guid>())).ReturnsAsync(auction);
        _auctionRepo.Setup(repo => repo.SaveChangesAsync()).ReturnsAsync(true);

        // act
        var result = await _controller.UpdateAuction(auction.Id, auctionUpdated);
    ...
    public async Task UpdateAuction_WithInvalidGuid_ReturnsNotFound()
    {
        ...
        // act
        var result = await _controller.UpdateAuction(Guid.NewGuid(), auctionUpdated);
